...
const ProductDetail = () => {
  ...
  return (
    <>
      <div className="product-detail-container flex flex-col lg:flex-row p-8 space-y-8 lg:space-y-0 lg:space-x-8">
        <div className="w-full lg:w-1/2 flex">
          <div className="flex flex-col items-center space-y-4">
            <button
              className="button-scroll bg-btNextPrev w-16 rounded-lg flex items-center justify-center"
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="text-customeBlue text-2xl font-bold mb-4">
            <p className="pb-2 text-black text-sm">Giá khuyến mãi:</p>
            17.999.000₫{" "}
          ...
          <div className="store-container p-2 border-1 rounded-2xl mx-2">
            <div className="text-white px-4">
              <h2>9 CỬA HÀNG CÓ SẴN SẢN PHẨM</h2>
            </div>
            <div className="bg-white border rounded-b-lg rounded-bl-lg">
              <ul className="bg-white divide-y divide-gray-300 px-4">
                {stores
              ...
              <button
                className="mt-2 bg-white text-blue-500 hover:underline px-4 pb-2 rounded-bl-lg"
                onClick={toggleShowAllStore}
              >
                {showAllStore ? "Ẩn bớt" : "Xem thêm 7 cửa hàng"}
              </button>
            </div>
          </div>

          <div className="mt-4 px-1 pb-1 border rounded-xl   bg-red-500">
            <div className="bg-red-500 text-white px-2 rounded-t">
              <h2>🎁 QUÀ TẶNG VÀ ƯU ĐÃI DÀNH CHO BẠN</h2>
            </div>
            <div className="bg-white rounded-b-xl rounded-bl-xl px-4 pb-4">
              <ul className="divide-y divide-gray-300">
                {promotions
                  .slice(0, showAllPromotions ? promotions.length : 4)
                  .map((promo, index) => (
              ...
              >
                {showAllPromotions ? "Ẩn bớt" : "Xem thêm ưu đãi"}
              </button>
            </div>
          </div>
